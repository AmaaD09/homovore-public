...
public class ModuleManager implements Jsonable, Util {
    ...
    public void init() {
        ...
        register(new dev.leonetic.features.modules.movement.FakeFlyModule());
        ...
        register(new dev.leonetic.features.modules.player.FakePlayerModule());
        register(new dev.leonetic.features.modules.player.NoRotateModule());
